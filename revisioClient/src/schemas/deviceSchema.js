...
export const deviceSchema = z.object({
  ...
  nominalVoltage: z.coerce.number({ invalid_type_error: "Menovité napätie musí byť číslo." }).positive("Menovité napätie musí byť väčšie ako 0."),
  nominalCurrent: z.coerce.number({ invalid_type_error: "Menovitý prúd musí byť číslo." }).positive("Menovitý prúd musí byť väčší ako 0."),
  nominalPower: z.coerce.number({ invalid_type_error: "Menovitý výkon musí byť číslo." }).positive("Menovitý výkon musí byť väčší ako 0."),
